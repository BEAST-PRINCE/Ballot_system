...
#         if login_type == "ADMIN":
#             name, user_data = login_admin(user_id, password)
...
#     logout_button = tk.Button(admin_dashboard_window, text="LOG OUT", command=self.logout)
#     logout_button.pack(pady=10)

# def view_candidates(self):
#     # Implement the functionality to view candidates of an election
#     # You may prompt the user for input, perform necessary operations, and display the results
#     pass

# def view_details(self):
#     # Implement the functionality to view election details
#     # You may prompt the user for input, perform necessary operations, and display the results
#     pass
...
#     # Implement the functionality to generate election results
#     # You may prompt the user for input, perform necessary operations, and display the results
#     pass

# def logout(self):
#     # Implement the logout functionality
#     # You may close the admin dashboard window and show the login screen again
#     pass

#     def show_voter_dashboard(self):
#         # Add logic to show voter dashboard
#         # For example, create a new window for voter dashboard
#         pass
...
def insert_election_values(admin_id):
    ...
    if int(year) <= datetime.date.today().year:
        print("Invalid Year of election")
        return
